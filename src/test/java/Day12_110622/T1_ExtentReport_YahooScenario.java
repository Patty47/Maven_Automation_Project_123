...
public class T1_ExtentReport_YahooScenario {
    WebDriver driver;
    ExtentReports reports = new ExtentReports("src/main/java/HTML_LIBRARY/Automation_Report.html", true);
    ExtentTest logger;
    ...
    public void tc001_verifySignedInOptionIsChecked() throws InterruptedException {
        ...
        boolean isStaySignInChecked = driver.findElement(By.xpath("//*[@id= 'persistent']")).isSelected();
        System.out.println("The checkbox check condition is: " + isStaySignInChecked);
        logger.log(LogStatus.INFO, "The checkbox check condition is: " + isStaySignInChecked);
